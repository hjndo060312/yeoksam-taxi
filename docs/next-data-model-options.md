...
- 수요 예측보다는 공급 anchor와 지도 해석에 좋습니다.
...
- 지도/그래프 해석에는 정확한 숫자보다 hotspot 여부가 더 중요할 수 있습니다.
...
- 시각화에서 보수적/공격적 경고 단계를 나눌 수 있습니다.
...
- 설명이 어려워집니다.
- 발표 리스크가 큽니다.
- 현재 목표는 “택시 수요 proxy를 지도/그래프로 넘기는 것”이지, 딥러닝 자체가 목표가 아닙니다.
...
이렇게 하면 발표에서는 “데이터를 더 잘 붙여서 택시 수요 proxy를 강화했다”라고 말할 수 있고, 구현에서는 지도/그래프에 바로 쓰기 좋은 JSON을 만들 수 있습니다.
